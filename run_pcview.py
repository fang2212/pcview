...
parser.add_argument("--video", help="是否保存视频[0,1]，默认保存", type=int)
#parser.add_argument("--alert", help="是否保存警报数据，包括警报日志，用于演示平台，默认不保存",type=str)
parser.add_argument("--log", help="是否保存日志[0,1],默认保存", type=int)
...
parser.add_argument("--all_laneline", help="是否显示所有车道[0,1]，默认不显示", type=int)
...
parser.add_argument("--show_parameters", help="左上角的数据，默认xian", type=str)
